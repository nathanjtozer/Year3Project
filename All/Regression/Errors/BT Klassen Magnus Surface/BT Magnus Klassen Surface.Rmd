...
BT.fit.hard <- glm(ymat.BT.hard ~ 0 + X.BT.hard, family=binomial(link=cloglog))
summary(BT.fit.hard)
```
...
BT.fit.clay <- glm(ymat.BT.clay ~ 0 + X.BT.clay, family=binomial(link=cloglog))
summary(BT.fit.clay)
```
...
BT.fit.grass <- glm(ymat.BT.grass ~ 0 + X.BT.grass, family=binomial(link=cloglog))
