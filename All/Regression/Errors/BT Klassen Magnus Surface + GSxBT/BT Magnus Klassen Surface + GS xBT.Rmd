...
```{r}
load('HardStrength.RData')
load('ClayStrength.RData')
load('GrassStrength.RData')
```
...
for (i in(1:N)){
  ...
  X.GS.hard[i] <- ifelse(training.df.hard$Series[i] == 'Grand Slam', log(winner.BT.hard/loser.BT.hard), 0)
  ymat.BT.hard[i,1] <- 1 
}

BT.fit.hard <- glm(ymat.BT.hard ~ 0 + X.BT.hard + X.GS.hard, family=binomial(link=logit))
summary(BT.fit.hard)
```
...
for (i in (1:M)){
  ...
  X.GS.test.hard[i] <- ifelse(training.df.hard$Series[i] == 'Grand Slam', log(winner.BT.test.hard/loser.BT.test.hard), 0)
  
}
X.BT.test.hard <- as.data.frame(X.BT.test.hard)
X.BT.test.hard <- cbind(X.BT.test.hard, as.data.frame(X.GS.test.hard))
colnames(X.BT.test.hard) <- c('X.BT.hard','X.GS.hard')
...
for (i in(1:N)){
  ...
  X.GS.clay[i] <- ifelse(training.df.clay$Series[i] == 'Grand Slam', log(winner.BT.clay/loser.BT.clay), 0)
  ymat.BT.clay[i,1] <- 1 
}

BT.fit.clay <- glm(ymat.BT.clay ~ 0 + X.BT.clay + X.GS.clay, family=binomial(link=logit))
summary(BT.fit.clay)
```
...
for (i in (1:M)){
  ...
  X.GS.test.clay[i] <- ifelse(training.df.clay$Series[i] == 'Grand Slam', log(winner.BT.test.clay/loser.BT.test.clay), 0)
}
X.BT.test.clay <- as.data.frame(X.BT.test.clay)
X.BT.test.clay <- cbind(X.BT.test.clay, as.data.frame(X.GS.test.clay))
colnames(X.BT.test.clay) <- c('X.BT.clay','X.GS.clay')
...
for (i in(1:N)){
  ...
  X.GS.grass[i] <- ifelse(training.df.grass$Series[i] == 'Grand Slam', log(winner.BT.grass/loser.BT.grass), 0)
  ymat.BT.grass[i,1] <- 1 
}

BT.fit.grass <- glm(ymat.BT.grass ~ 0 + X.BT.grass + X.GS.grass, family=binomial(link=logit))
...
for (i in (1:M)){
  ...
  X.GS.test.grass[i] <- ifelse(training.df.grass$Series[i] == 'Grand Slam', log(winner.BT.test.grass/loser.BT.test.grass), 0)
}
X.BT.test.grass<- as.data.frame(X.BT.test.grass)
X.BT.test.grass <- cbind(X.BT.test.grass, as.data.frame(X.GS.test.grass))
colnames(X.BT.test.grass) <- c('X.BT.grass','X.GS.grass')
...
calibration(rank.analysis.df, 'BT.Magnus.KLassen.surface.GS')
```